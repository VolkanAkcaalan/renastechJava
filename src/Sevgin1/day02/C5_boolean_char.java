...
public class C5_boolean_char {
    ...
    public static void main(String[] args){
        ...
        System.out.println(10 == 25); // false
        // ==means equal
       ...
       // char1   2 bytes           Stores a single character/letter or ASCII values    'a'

        char ch1= 'a' ; // char is for single character
        // char ch2 = 'abc' this won't work because it has 3 character
